...
**Status:** HF0–HF18 first cycle complete/frozen; HF19 production/economic-organization, HF20 perception, HF21 affect/emotion and HD3-derived HF22 persistent-relations extensions complete/READY. Human Foundations remains an active reusable research programme, not a mandatory personal schema or replacement for problem-first applied cycles.

HF0 introduces the projection/coordinate grammar. HF1 separates typed identity. HF2 separates experience from state/evidence. HF3 separates attention/access/working memory/metacognition/control. HF4 separates goals/value/reward/effort/motivation/self-regulation. HF5 reconstructs organismic regulation. HF6 reconstructs persistent history-dependent change. HF7 reconstructs memory/retention/retrieval. HF8 reconstructs representation/knowledge/belief/concepts/models/understanding. HF9 reconstructs inference/reasoning/causality/problem solving. HF10 reconstructs sequential decision/planning. HF11 reconstructs realized situated action. HF12 reconstructs current relational multi-agent action. HF13 reconstructs population/institution-level persistent social order. HF14 reconstructs normative evaluation. HF15 reconstructs moral standing/bearer conditions. HF16 reconstructs population/temporal aggregation. HF17 reconstructs collective normative choice. HF18 reconstructs strategic implementation. HF19 reconstructs production/economic organization. HF20 reconstructs perceptual world coupling. HF21 reconstructs affective world coupling. HF22 fills the scale gap between current interaction and persistent social order by representing participant-specific relationship state across interaction and noninteraction: attachment, care, trust profiles, commitment, dependence/interdependence, shared history, relation models, conflict/repair, asymmetry and institutional embedding remain separately typed.

**Current completed foundation extension:** [`foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md), extracted from completed deep research in [`deep-foundations/HD3-SOCIAL-COGNITION-OTHER-MIND-ATTACHMENT-RELATIONS.md`](deep-foundations/HD3-SOCIAL-COGNITION-OTHER-MIND-ATTACHMENT-RELATIONS.md). HD3 explicitly rejected a standalone Theory-of-Mind foundation because typed other-mind modeling remains composable from HF8/HF9/HF12/HF21.

**Current foundation continuation:** [`foundations/HF22-CONTINUATION.md`](foundations/HF22-CONTINUATION.md). HF23 is UNKNOWN / not admitted; no existing HF round was reopened by HD3/HF22.

**Current deep-research direction:** [`deep-foundations/HD3-CONTINUATION.md`](deep-foundations/HD3-CONTINUATION.md) admits HD4 — Social Learning, Imitation, Teaching, Cultural Transmission and Cumulative/Open-Ended Culture — as a non-foundation deep route. `HD4 != HF23`. Language/symbol remains an adjacent high-priority residual. Evolution/comparative, development/lifespan, cross-cultural/historical, pathology/lesion, disability/compensation, altered-state and Human×AI analyses remain recurring pressure axes rather than a fixed curriculum.
