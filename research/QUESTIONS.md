...
**Status:** HF0–HF18 first cycle complete/frozen; HF19 production/economic-organization, HF20 perception, HF21 affect/emotion and HF22 persistent-relations extensions complete/READY. HD4 cultural-inheritance deep research is complete but admitted no HF23. Human Foundations remains an active reusable research programme, not a mandatory personal schema or replacement for problem-first applied cycles.

HF0 introduces the projection/coordinate grammar. HF1 separates typed identity. HF2 separates experience from state/evidence. HF3 separates attention/access/working memory/metacognition/control. HF4 separates goals/value/reward/effort/motivation/self-regulation. HF5 reconstructs organismic regulation. HF6 reconstructs persistent history-dependent change. HF7 reconstructs memory/retention/retrieval. HF8 reconstructs representation/knowledge/belief/concepts/models/understanding. HF9 reconstructs inference/reasoning/causality/problem solving. HF10 reconstructs sequential decision/planning. HF11 reconstructs realized situated action. HF12 reconstructs current relational multi-agent action. HF13 reconstructs population/institution-level persistent social order. HF14 reconstructs normative evaluation. HF15 reconstructs moral standing/bearer conditions. HF16 reconstructs population/temporal aggregation. HF17 reconstructs collective normative choice. HF18 reconstructs strategic implementation. HF19 reconstructs production/economic organization. HF20 reconstructs perceptual world coupling. HF21 reconstructs affective world coupling. HF22 reconstructs persistent participant-specific relationship state. HD4 does not add a new peer foundation: it supplies the cross-foundation cultural-inheritance loop linking variation/reconstruction, expression/artifacts, social exposure, selective acquisition, retention/transformation, population selection/drift/recombination/loss and the changed developmental environment of later Humans.

**Current completed foundation extension:** [`foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md). The completed cultural-inheritance deep owner is [`deep-foundations/HD4-SOCIAL-LEARNING-CULTURAL-TRANSMISSION-CUMULATIVE-CULTURE.md`](deep-foundations/HD4-SOCIAL-LEARNING-CULTURAL-TRANSMISSION-CUMULATIVE-CULTURE.md); HD4 explicitly rejected both a standalone Social Learning foundation and a generic Culture foundation because their surviving mechanisms compose existing HF owners.

**Current foundation continuation:** [`foundations/HF22-CONTINUATION.md`](foundations/HF22-CONTINUATION.md). HF23 remains UNKNOWN / not admitted; no existing HF round was reopened by HD4. The durable gate result is `DeepImportance != FoundationAdmission`.

**Current deep-research direction:** [`deep-foundations/HD4-CONTINUATION.md`](deep-foundations/HD4-CONTINUATION.md) admits HD5 — Language, Symbol, Reference, Meaning, Compositionality and Generative Symbolic Systems — as a non-foundation deep route. `HD5 != HF23`. HD/HF numbering is now intentionally decoupled when a deep route does not produce a foundation extension. Evolution/comparative, development/lifespan, cross-cultural/historical, pathology/lesion, disability/compensation, altered-state and Human×AI analyses remain recurring pressure axes rather than a fixed curriculum.

**Cycle closeout:** [`foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md`](foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md) remains the historical frozen first-cycle closeout/reopen protocol; HF19–HF22 extend that library without rewriting its historical state.
