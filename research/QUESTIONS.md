...
**Status:** HF0–HF18 first cycle complete/frozen; HF19 production/economic-organization, HF20 perception, HF21 affect/emotion, HF22 persistent relations and HD5-derived HF23 generative-symbolic-system extensions complete/READY. HD4 cultural inheritance and HD6 sex/sexuality/reproduction remain completed cross-foundation/cross-layer deep owners rather than new HF extensions. Human Foundations remains an active reusable research programme, not a mandatory personal schema or replacement for problem-first applied cycles.

HF0 introduces the projection/coordinate grammar. HF1 separates typed identity. HF2 separates experience from state/evidence. HF3 separates attention/access/working memory/metacognition/control. HF4 separates goals/value/reward/effort/motivation/self-regulation. HF5 reconstructs organismic regulation. HF6 reconstructs persistent history-dependent change. HF7 reconstructs memory/retention/retrieval. HF8 reconstructs representation/knowledge/belief/concepts/models/understanding. HF9 reconstructs inference/reasoning/causality/problem solving. HF10 reconstructs sequential decision/planning. HF11 reconstructs realized situated action. HF12 reconstructs current relational multi-agent action and communication events. HF13 reconstructs population/institution-level persistent social order. HF14 reconstructs normative evaluation. HF15 reconstructs moral standing/bearer conditions. HF16 reconstructs population/temporal aggregation. HF17 reconstructs collective normative choice. HF18 reconstructs strategic implementation. HF19 reconstructs production/economic organization. HF20 reconstructs perceptual world coupling. HF21 reconstructs affective world coupling. HF22 reconstructs persistent participant-specific relationship state. HF23 reconstructs persistent generative symbolic systems. HD6 adds no peer foundation: it owns the sex/sexuality/reproduction domain grammar that separates sex-related biological profiles, puberty/reproductive maturation, multidimensional sexuality, arousal/behavior/consent, fertility/conception/pregnancy, genetic/gestational/social parenthood and reproductive aging while composing existing HF owners.

**Current completed foundation extension:** [`foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md`](foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md). HD6 explicitly rejects Biological Sex, Sexuality, Reproductive State/Life History and unified Sex/Sexuality/Reproduction as HF24 candidates after cross-context decomposition; full domain evidence is owned by [`deep-foundations/HD6-SEX-SEXUALITY-REPRODUCTION-LIFE-HISTORY.md`](deep-foundations/HD6-SEX-SEXUALITY-REPRODUCTION-LIFE-HISTORY.md) and [`deep-foundations/HD6-SOURCES.md`](deep-foundations/HD6-SOURCES.md).

**Current foundation continuation:** [`foundations/HF23-CONTINUATION.md`](foundations/HF23-CONTINUATION.md). HF24 remains UNKNOWN / not admitted; no existing HF round was reopened by HD6.

**Current deep-research direction:** [`deep-foundations/HD6-CONTINUATION.md`](deep-foundations/HD6-CONTINUATION.md) admits HD7 — Genetic Variation, Heredity, Gene–Environment Development and Individual Differences — as the next non-foundation deep route. `HD7 != HF24`. Narrative/imagination remains a later residual rather than being discarded. Evolution/comparative, development/lifespan, cross-cultural/historical, pathology/lesion, disability/compensation, altered-state and Human×AI analyses remain recurring pressure axes rather than a fixed curriculum.
