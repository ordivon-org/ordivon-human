...
**Status:** HF0–HF18 first cycle complete/frozen; HF19 production/economic-organization, HF20 perception, HF21 affect/emotion, HF22 persistent relations and HD5-derived HF23 generative-symbolic-system extensions complete/READY. HD4 cultural inheritance, HD6 sex/sexuality/reproduction and HD7 genetics/heredity/individual differences remain completed cross-foundation/cross-layer deep owners rather than new HF extensions. Human Foundations remains an active reusable research programme, not a mandatory personal schema or replacement for problem-first applied cycles.

HF0 introduces the projection/coordinate grammar. HF1 separates typed identity. HF2 separates experience from state/evidence. HF3 separates attention/access/working memory/metacognition/control. HF4 separates goals/value/reward/effort/motivation/self-regulation. HF5 reconstructs organismic regulation. HF6 reconstructs persistent history-dependent change. HF7 reconstructs memory/retention/retrieval. HF8 reconstructs representation/knowledge/belief/concepts/models/understanding. HF9 reconstructs inference/reasoning/causality/problem solving. HF10 reconstructs sequential decision/planning. HF11 reconstructs realized situated action. HF12 reconstructs current relational multi-agent action and communication events. HF13 reconstructs population/institution-level persistent social order. HF14 reconstructs normative evaluation. HF15 reconstructs moral standing/bearer conditions. HF16 reconstructs population/temporal aggregation. HF17 reconstructs collective normative choice. HF18 reconstructs strategic implementation. HF19 reconstructs production/economic organization. HF20 reconstructs perceptual world coupling. HF21 reconstructs affective world coupling. HF22 reconstructs persistent participant-specific relationship state. HF23 reconstructs persistent generative symbolic systems. HD7 adds no peer foundation: it owns the genetics/heredity domain grammar separating genomic state, regulation, phenotype, association/direct effect, heritability, G×E/rGE/indirect effects, ancestry/population structure, prediction and individual-difference inference while composing existing HF owners.

**Current completed foundation extension:** [`foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md`](foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md). HD7 explicitly rejects Genome/Genomic State, Heredity, Individual Differences and Nature/Nurture as HF24 candidates after decomposition; full deep evidence is owned by [`deep-foundations/HD7-GENETIC-VARIATION-HEREDITY-GENE-ENVIRONMENT-INDIVIDUAL-DIFFERENCES.md`](deep-foundations/HD7-GENETIC-VARIATION-HEREDITY-GENE-ENVIRONMENT-INDIVIDUAL-DIFFERENCES.md) and [`deep-foundations/HD7-SOURCES.md`](deep-foundations/HD7-SOURCES.md).

**Current foundation continuation:** [`foundations/HF23-CONTINUATION.md`](foundations/HF23-CONTINUATION.md). HF24 remains UNKNOWN / not admitted; no existing HF round was reopened by HD7.

**Current deep-research direction:** [`deep-foundations/HD7-CONTINUATION.md`](deep-foundations/HD7-CONTINUATION.md) records a post-HD7 global residual scan confirming HD8 — Evolution, Phylogeny, Population Change, Natural Selection and Human Specificity — as the next non-foundation deep route. `HD8 != HF24`. Narrative/imagination, organism systems and collective identity remain later residuals rather than being discarded. Development/lifespan, cross-cultural/historical, pathology/lesion, disability/compensation, altered-state and Human×AI analyses remain recurring pressure axes rather than a fixed curriculum.
