...
**Status:** HF0–HF18 first cycle complete/frozen; HF19 production/economic-organization, HF20 perception, HF21 affect/emotion, HF22 persistent relations and HD5-derived HF23 generative-symbolic-system extensions complete/READY. HD4 cultural inheritance remains a completed cross-foundation deep process rather than HF23. Human Foundations remains an active reusable research programme, not a mandatory personal schema or replacement for problem-first applied cycles.

HF0 introduces the projection/coordinate grammar. HF1 separates typed identity. HF2 separates experience from state/evidence. HF3 separates attention/access/working memory/metacognition/control. HF4 separates goals/value/reward/effort/motivation/self-regulation. HF5 reconstructs organismic regulation. HF6 reconstructs persistent history-dependent change. HF7 reconstructs memory/retention/retrieval. HF8 reconstructs representation/knowledge/belief/concepts/models/understanding. HF9 reconstructs inference/reasoning/causality/problem solving. HF10 reconstructs sequential decision/planning. HF11 reconstructs realized situated action. HF12 reconstructs current relational multi-agent action and communication events. HF13 reconstructs population/institution-level persistent social order. HF14 reconstructs normative evaluation. HF15 reconstructs moral standing/bearer conditions. HF16 reconstructs population/temporal aggregation. HF17 reconstructs collective normative choice. HF18 reconstructs strategic implementation. HF19 reconstructs production/economic organization. HF20 reconstructs perceptual world coupling. HF21 reconstructs affective world coupling. HF22 reconstructs persistent participant-specific relationship state. HF23 reconstructs persistent generative symbolic systems between generic representation and particular communication/use events: reusable sign/form types, stabilized form↔content mappings, construction/combination resources, semantic/reference resources, pragmatic conventions, productivity and external inscription links remain separately typed.

**Current completed foundation extension:** [`foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md`](foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md), extracted from completed deep research in [`deep-foundations/HD5-LANGUAGE-SYMBOL-REFERENCE-MEANING-GENERATIVE-SYSTEMS.md`](deep-foundations/HD5-LANGUAGE-SYMBOL-REFERENCE-MEANING-GENERATIVE-SYSTEMS.md). HD5 rejects a narrow speech/writing-centered Language foundation and instead extracts the modality-broader Generative Symbolic System; it preserves `Language != Thought`, `Language != Communication`, `Semantics != Pragmatics`, `Compositionality != Productivity`, `Writing != Language` and multidimensional grounding boundaries.

**Current foundation continuation:** [`foundations/HF23-CONTINUATION.md`](foundations/HF23-CONTINUATION.md). HF24 is UNKNOWN / not admitted; no existing HF round was reopened by HD5/HF23.

**Current deep-research direction:** [`deep-foundations/HD5-CONTINUATION.md`](deep-foundations/HD5-CONTINUATION.md) provisionally localizes HD6 — Narrative, Imagination, Fiction, Event Models and Possible-World Construction — as a non-foundation deep route, subject to a lightweight residual check before execution. `HD6 != HF24`. Evolution/comparative, development/lifespan, cross-cultural/historical, pathology/lesion, disability/compensation, altered-state and Human×AI analyses remain recurring pressure axes rather than a fixed curriculum.
