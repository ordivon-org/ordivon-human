...
The current foundation entry is [`research/foundations/README.md`](research/foundations/README.md). The current completed extension is [`research/foundations/HF21-AFFECT-EMOTION-MOOD-APPRAISAL.md`](research/foundations/HF21-AFFECT-EMOTION-MOOD-APPRAISAL.md), extracted from HD2; HF20 perception and HF19 production/economic organization remain preserved completed extensions. The compact frozen HF0–HF18 cycle handoff remains [`research/foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md`](research/foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md).

HD1/HF20 perception is now followed by the completed [`research/deep-foundations/HD2-AFFECT-EMOTION-MOOD-APPRAISAL.md`](research/deep-foundations/HD2-AFFECT-EMOTION-MOOD-APPRAISAL.md). HD2 showed that affective coordination was another repeated interface-rich/mechanism-thin neighboring structure spanning HF4/HF5/HF14/HF20 and downstream cognition/action/social foundations. Cross-cultural expression, spontaneous-versus-posed displays, appraisal/event structure, amygdala lesions, interoceptive perturbation, development, mood-learning and social-emotion evidence satisfied the same explicit admission gate without falsifying HF0–HF20.

The resulting thin canonical extraction is [`research/foundations/HF21-AFFECT-EMOTION-MOOD-APPRAISAL.md`](research/foundations/HF21-AFFECT-EMOTION-MOOD-APPRAISAL.md). HF21 separates affect, emotion episode/category, mood, appraisal, valence, arousal, interoceptive/physiological components, action readiness, conscious feeling, expression/display, attribution and regulation while preserving plural discrete, dimensional, appraisal, constructionist, interoceptive, learning, action, social and evolutionary views. [`research/foundations/HF21-CONTINUATION.md`](research/foundations/HF21-CONTINUATION.md) is now the foundation-level continuation; **HF22 remains UNKNOWN / not admitted**.

Human Deep Foundations continues separately. [`research/deep-foundations/HD2-CONTINUATION.md`](research/deep-foundations/HD2-CONTINUATION.md) admits **HD3 — Social Cognition, Other-Mind Modeling, Attachment, Care and Persistent Relations** as the next non-foundation deep route. `HD3 != HF22`; later canonical promotion again requires its own repeated-residual evidence.
