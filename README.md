...
The current foundation entry is [`research/foundations/README.md`](research/foundations/README.md). The current completed extension is [`research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md), extracted from HD3; HF21 affect/emotion, HF20 perception and HF19 production/economic organization remain preserved completed extensions. The compact frozen HF0–HF18 cycle handoff remains [`research/foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md`](research/foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md).

The completed [`research/deep-foundations/HD3-SOCIAL-COGNITION-OTHER-MIND-ATTACHMENT-RELATIONS.md`](research/deep-foundations/HD3-SOCIAL-COGNITION-OTHER-MIND-ATTACHMENT-RELATIONS.md) pressure-tested social cognition, other-mind modeling, empathy, joint attention, attachment, care, trust, kinship, loneliness and Human–AI relational responses. HD3 found an asymmetric result: typed other-mind modeling is a deep mechanism composable from existing HF8/HF9/HF12/HF21 surfaces, so it does **not** warrant a standalone Theory-of-Mind foundation; persistent participant-specific relationship state does warrant a new neighboring foundation because it persists beyond current interaction while remaining distinct from population/institution-level social order.

The resulting thin canonical extraction is [`research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md). Its central scale firewall is `CurrentInteraction != PersistentRelationship != PersistentSocialOrder`; it further separates relationship from trust, attachment, care, dependence, closeness, household/genetic kinship and institution, permits asymmetric/multiplex/mediated relations, and keeps Human felt connection to AI separate from reciprocal machine experience. [`research/foundations/HF22-CONTINUATION.md`](research/foundations/HF22-CONTINUATION.md) is now the foundation-level continuation; **HF23 remains UNKNOWN / not admitted**.

Human Deep Foundations continues separately. [`research/deep-foundations/HD3-CONTINUATION.md`](research/deep-foundations/HD3-CONTINUATION.md) admits **HD4 — Social Learning, Imitation, Teaching, Cultural Transmission and Cumulative/Open-Ended Culture** as the next non-foundation deep route. `HD4 != HF23`; language/symbol remains adjacent and may merge with or follow that route if evidence requires it.
