...
[`research/foundations/HF19-CONTINUATION.md`](research/foundations/HF19-CONTINUATION.md) owns the current continuation. No successor foundation is named or scheduled: the next foundation remains UNKNOWN until repeated cross-context failures expose a neighboring distinction that HF0–HF19 cannot represent without arbitrary hidden choices. Do not reopen HF0–HF18 without a concrete `FoundationReopenCondition`.
