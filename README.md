...
Human Deep Foundations continues separately. The post-HD9 global residual scan recorded in [`research/deep-foundations/HD9-CONTINUATION.md`](research/deep-foundations/HD9-CONTINUATION.md) selects **HD10 — Narrative, Imagination, Fiction, Event Models and Possible-World Construction** as the next non-foundation deep route. `HD10 != HF24`; collective identity/intergroup dynamics, psychopathology, sleep/dreaming, built environment/ecology and creativity/play/aesthetics remain in the residual pool.
