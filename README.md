...
The current foundation entry is [`research/foundations/README.md`](research/foundations/README.md). The current completed extension remains [`research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md); **HD4 did not create HF23**. HF21 affect/emotion, HF20 perception and HF19 production/economic organization remain preserved completed extensions. The compact frozen HF0–HF18 cycle handoff remains [`research/foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md`](research/foundations/HF0-HF18-CYCLE-CLOSEOUT-20260817.md).

The completed [`research/deep-foundations/HD4-SOCIAL-LEARNING-CULTURAL-TRANSMISSION-CUMULATIVE-CULTURE.md`](research/deep-foundations/HD4-SOCIAL-LEARNING-CULTURAL-TRANSMISSION-CUMULATIVE-CULTURE.md) reconstructs social learning, teaching, transmission, tradition, cultural evolution, cumulative culture and open-ended-culture candidates across developmental, comparative, small-scale-society, network/population and Human×AI pressure. Its main result is methodological as well as substantive: cultural inheritance is a real population-historical dynamic, but it is distributed across HF6 learning, HF7 external memory, HF8 knowledge/provenance, HF10 source/search decisions, HF12 social channels, HF13 persistent social order, HF19 artifacts/technology and HF22 relationship pathways. A generic `Culture` foundation would duplicate those owners or become an unbounded catch-all.

Therefore [`research/foundations/HF22-CONTINUATION.md`](research/foundations/HF22-CONTINUATION.md) remains the current foundation-level continuation and **HF23 remains UNKNOWN / not admitted**. The durable HD4 rule is `DeepImportance != FoundationAdmission`: a cross-cutting mechanism may deserve a canonical deep owner and reusable grammar without becoming a peer foundation.

Human Deep Foundations continues separately. [`research/deep-foundations/HD4-CONTINUATION.md`](research/deep-foundations/HD4-CONTINUATION.md) admits **HD5 — Language, Symbol, Reference, Meaning, Compositionality and Generative Symbolic Systems** as the next non-foundation deep route. `HD5 != HF23`; because HD4 produced no HF extension, HD and HF numbering are now intentionally decoupled.
