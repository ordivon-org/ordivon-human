...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is perception; HF21 is affective world coupling. HD3 has now pressure-tested social cognition, other-mind modeling, empathy, joint attention, attachment, care, trust, kinship, loneliness and Human–AI relational response.

HD3 produced an intentionally asymmetric result. Other-mind modeling is a genuine deep mechanism, but typed partner models can be represented through existing HF8 representation, HF9 inference, HF12 interaction and HF21 affective attribution without a new standalone Theory-of-Mind foundation. Persistent participant-specific relationship state is different: friendship/attachment/care can persist across noninteraction, remain asymmetric and multiplex, regulate capability/stress, and yet remain distinct from HF13 population/institution-level social order. That scale gap satisfied the explicit `NextFoundationAdmissionCondition` without contradicting any established HF claim.

The resulting canonical extension is [`../research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](../research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md), with evidence bridge [`../research/foundations/HF22-SOURCES.md`](../research/foundations/HF22-SOURCES.md) and current foundation continuation [`../research/foundations/HF22-CONTINUATION.md`](../research/foundations/HF22-CONTINUATION.md). HF22 is the thin reusable surface; [`../research/deep-foundations/HD3-SOCIAL-COGNITION-OTHER-MIND-ATTACHMENT-RELATIONS.md`](../research/deep-foundations/HD3-SOCIAL-COGNITION-OTHER-MIND-ATTACHMENT-RELATIONS.md) and [`../research/deep-foundations/HD3-SOURCES.md`](../research/deep-foundations/HD3-SOURCES.md) own the full mechanism/model/evidence/falsifier reconstruction. **HF23 is UNKNOWN / not admitted.**

The separate second-generation **Human Deep Foundations** mode remains the mechanism-depth pressure layer. [`../research/deep-foundations/HD3-CONTINUATION.md`](../research/deep-foundations/HD3-CONTINUATION.md) admits **HD4 — Social Learning, Imitation, Teaching, Cultural Transmission and Cumulative/Open-Ended Culture** as the next non-foundation route. `HD4 != HF23`; language/symbol remains an adjacent high-priority residual and may merge with or follow that route if the evidence requires it.
