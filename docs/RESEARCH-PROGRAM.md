...
## Human Foundations — active programme; HF0–HF22 established
...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is perception; HF21 is affective world coupling; HF22 is persistent participant-specific relationship state. HD4 has now pressure-tested social learning, imitation/emulation, selective source use, teaching, transmission, tradition, cultural evolution, cumulative/open-ended culture, population/network structure, distributed cultural memory and Human×AI cultural-source effects.

HD4 produced a second deliberately asymmetric result. Social learning is a deep causal pathway into HF6 learning through social/artifact sources, but it does not require a standalone foundation. Generic Culture/cultural inheritance is even more fundamental, yet it is not one neighboring object: its surviving dynamics span HF6 learner change, HF7 memory/external memory, HF8 representation/provenance, HF10 source/search decisions, HF12 social channels, HF13 conventions/norms/institutions and intergenerational persistence, HF19 artifacts/technology/production and HF22 relationship pathways. A generic Culture HF would duplicate these owners or become an unbounded catch-all. HD4 therefore establishes `DeepImportance != FoundationAdmission` and treats cultural inheritance as a cross-foundation population-historical process.

The current foundation extension and continuation remain [`../research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md`](../research/foundations/HF22-PERSISTENT-RELATIONSHIPS-ATTACHMENT-CARE.md) and [`../research/foundations/HF22-CONTINUATION.md`](../research/foundations/HF22-CONTINUATION.md). **HF23 remains UNKNOWN / not admitted**, and no existing HF round was reopened by HD4.

The separate second-generation **Human Deep Foundations** mode remains the mechanism-depth pressure layer. [`../research/deep-foundations/HD4-SOCIAL-LEARNING-CULTURAL-TRANSMISSION-CUMULATIVE-CULTURE.md`](../research/deep-foundations/HD4-SOCIAL-LEARNING-CULTURAL-TRANSMISSION-CUMULATIVE-CULTURE.md) and [`../research/deep-foundations/HD4-SOURCES.md`](../research/deep-foundations/HD4-SOURCES.md) own the cultural-inheritance reconstruction; [`../research/deep-foundations/HD4-CONTINUATION.md`](../research/deep-foundations/HD4-CONTINUATION.md) admits **HD5 — Language, Symbol, Reference, Meaning, Compositionality and Generative Symbolic Systems** as the next non-foundation route. `HD5 != HF23`. From HD4 onward, HD and HF numbering are intentionally decoupled unless a deep route independently passes the foundation gate.
