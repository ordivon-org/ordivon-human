...
Only after passing that fresh deep-route gate, **HD15 — Bodily Self / Body Ownership / Sense of Agency / Self-Location / Body Representation** was admitted as a non-foundation route. HD15-A has now completed the current-use / term-separation / measurement / hidden-assumption round in [`../research/deep-foundations/HD15-A-CURRENT-USE-TERM-SEPARATION-HIDDEN-ASSUMPTION-INVENTORY.md`](../research/deep-foundations/HD15-A-CURRENT-USE-TERM-SEPARATION-HIDDEN-ASSUMPTION-INVENTORY.md), supported by [`../research/deep-foundations/HD15-A-SOURCES.md`](../research/deep-foundations/HD15-A-SOURCES.md). HD15-A separates physical/represented/experienced body, body-schema/image/model families, part/full-body ownership, disownership, self-location, perspective, sensory evidence, actual control and multiple agency judgments. It also establishes the mandatory measurement firewall `target construct != manipulation != readout`: proprioceptive drift, intentional binding, threat/SCR, questionnaire ratings, kinematics and neural localization cannot define ownership or agency by themselves. [`../research/deep-foundations/HD15-CONTINUATION.md`](../research/deep-foundations/HD15-CONTINUATION.md) is the current continuation boundary. **HD15-B — Rival Bodily-Self Architectures / Measurement Decomposition / Cross-Regime Destructive Falsification — is admitted next but not yet executed.** `NextHumanDeepRoute after HD15 = UNKNOWN`.
