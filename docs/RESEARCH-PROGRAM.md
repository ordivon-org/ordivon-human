...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is perception; HF21 is affective world coupling; HF22 is persistent participant-specific relationship state; HF23 is the HD5-derived generative-symbolic-system extension. HD8 has now completed the evolution/phylogeny/population-change/Human-specificity deep route after HD7, reconstructing population/lineage state, selection versus drift/migration/admixture, fitness, adaptation/exaptation, phylogenetic/comparative inference, archaic introgression, gene–culture feedback and niche construction.

HD8 strengthens the route-selection discipline and adds a historical/explanatory firewall: evolutionary change is not a progress axis and historical function is not present purpose. Its durable distinctions include `Evolution != Progress`, `AlleleFrequencyChange != Selection`, `Drift != Noise`, `Fitness != Welfare/MoralWorth`, `Adaptation != Optimality`, `CurrentUsefulness != HistoricalAdaptation`, `Convergence != Homology`, `Introgressed != Adaptive`, `HumanSpecific != HumanUniversal` and `EvolutionaryExplanation != ProximateMechanism`.

HD8 is a no-promotion result. Evolutionary history is a population/lineage historical causal-explanatory layer, adaptation/function are relations, and Human-specificity is a comparator-qualified classification rather than one Human subsystem. [`../research/foundations/HF23-CONTINUATION.md`](../research/foundations/HF23-CONTINUATION.md) therefore remains the current foundation continuation; **HF24 remains UNKNOWN / not admitted**, and HF0–HF23 were not reopened. [`../research/deep-foundations/HD8-EVOLUTION-PHYLOGENY-POPULATION-CHANGE-HUMAN-SPECIFICITY.md`](../research/deep-foundations/HD8-EVOLUTION-PHYLOGENY-POPULATION-CHANGE-HUMAN-SPECIFICITY.md) and [`../research/deep-foundations/HD8-SOURCES.md`](../research/deep-foundations/HD8-SOURCES.md) own the mechanism/evidence reconstruction.

The separate second-generation **Human Deep Foundations** mode continues through [`../research/deep-foundations/HD8-CONTINUATION.md`](../research/deep-foundations/HD8-CONTINUATION.md). A fresh global residual scan selects **HD9 — Organismic Systems, Health, Disease, Immune–Metabolic–Endocrine Integration and Pathophysiology** as the next non-foundation route. `HD9 != HF24`; narrative/imagination, collective identity, sleep/dreaming and psychopathology remain later residual candidates.
