...
Only after passing that fresh deep-route gate, **HD15 — Bodily Self / Body Ownership / Sense of Agency / Self-Location / Body Representation** was admitted as a non-foundation route. The route label does not assert one bodily-self process: body-part/full-body ownership, ownership/self-location, implicit/explicit agency, motor control/control detection/self-attribution, body schema, multisensory bodily evidence and lesion/VR/BMI regimes must be reconstructed against existing HF1/HF2/HF3/HF8/HF11/HF20 ownership. [`../research/deep-foundations/HD15-CONTINUATION.md`](../research/deep-foundations/HD15-CONTINUATION.md) is the current continuation boundary. HD15-A Current-Use / Term Separation / Hidden-Assumption Inventory is next within this admitted route but has not yet been executed. `NextHumanDeepRoute after HD15 = UNKNOWN`.
