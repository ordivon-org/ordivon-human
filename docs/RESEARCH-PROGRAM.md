...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is perception; HF21 is affective world coupling; HF22 is persistent participant-specific relationship state; HF23 is the HD5-derived generative-symbolic-system extension. HD6 has now completed the fresh residual scan required by HD5 and reconstructed sex, sexuality, reproduction, reproductive development and life-history transitions across DSD/sex-development variation, puberty, multidimensional sexuality, sexual-response psychophysiology, fertility, pregnancy, parenthood and reproductive aging.

HD6 records an important direction-selection correction: the strongest local residual exposed by one route is not automatically the strongest global residual. Narrative/imagination remains under-modeled, but repository-wide comparison showed that sex/sexuality/reproduction had much weaker mechanism coverage despite higher organismic/developmental centrality. The reconstructed domain separates sex-related biological profiles from identity/social classification; puberty from chronological age; identity/attraction/desire/arousal/behavior/consent; sexuality from reproduction; conception/pregnancy/birth from parenthood; genetic/gestational/social parent roles; and reproductive aging from chronological aging.

HD6 is a no-promotion result. Its strongest firewall is `SexRelatedBiology != Sexuality != Reproduction != Parenthood`; no unified peer foundation survives decomposition. The domain instead composes HF1, HF4, HF5, HF6, HF10, HF14, HF16, HF21, HF22 and HF23 plus question-specific organismic/genetic variables. [`../research/foundations/HF23-CONTINUATION.md`](../research/foundations/HF23-CONTINUATION.md) therefore remains the current foundation continuation; **HF24 remains UNKNOWN / not admitted**, and HF0–HF23 were not reopened. [`../research/deep-foundations/HD6-SEX-SEXUALITY-REPRODUCTION-LIFE-HISTORY.md`](../research/deep-foundations/HD6-SEX-SEXUALITY-REPRODUCTION-LIFE-HISTORY.md) and [`../research/deep-foundations/HD6-SOURCES.md`](../research/deep-foundations/HD6-SOURCES.md) own the domain mechanism/evidence reconstruction.

The separate second-generation **Human Deep Foundations** mode continues through [`../research/deep-foundations/HD6-CONTINUATION.md`](../research/deep-foundations/HD6-CONTINUATION.md), which admits **HD7 — Genetic Variation, Heredity, Gene–Environment Development and Individual Differences** as the next non-foundation route. `HD7 != HF24`; narrative/imagination remains a later residual candidate rather than being discarded.
