...
Only after passing that fresh deep-route gate, **HD15 — Bodily Self / Body Ownership / Sense of Agency / Self-Location / Body Representation** was admitted as a non-foundation route. HD15-A completed the current-use / term-separation / measurement firewall in [`../research/deep-foundations/HD15-A-CURRENT-USE-TERM-SEPARATION-HIDDEN-ASSUMPTION-INVENTORY.md`](../research/deep-foundations/HD15-A-CURRENT-USE-TERM-SEPARATION-HIDDEN-ASSUMPTION-INVENTORY.md). HD15-B has now completed the common-battery destructive rival tournament in [`../research/deep-foundations/HD15-B-RIVAL-BODILY-SELF-ARCHITECTURES-MEASUREMENT-DECOMPOSITION-CROSS-REGIME-FALSIFICATION.md`](../research/deep-foundations/HD15-B-RIVAL-BODILY-SELF-ARCHITECTURES-MEASUREMENT-DECOMPOSITION-CROSS-REGIME-FALSIFICATION.md), supported by [`../research/deep-foundations/HD15-B-SOURCES.md`](../research/deep-foundations/HD15-B-SOURCES.md). No unitary/minimal-self architecture survives as whole-domain owner. The best current whole-route synthesis is `LayeredPluralBodilySelfArchitecture = composition, not Foundation`; the ownership-relevant residuals are `BodyOwnershipCausalInferenceProjection`, `PartWholeOwnershipIntegrationProjection`, and `AgencyCueIntegrationProjection`. [`../research/deep-foundations/HD15-CONTINUATION.md`](../research/deep-foundations/HD15-CONTINUATION.md) is the current continuation boundary. **HD15-C — Cross-Regime Invariance / Selective Dissociation / Bodily-Self Ownership Extraction — is admitted next but not yet executed.** HF24 and HOC11 remain UNKNOWN/not admitted; `NextHumanDeepRoute after HD15 = UNKNOWN`.
