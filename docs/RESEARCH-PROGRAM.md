...
## Human Foundations — active programme; HF0–HF21 established
...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is the HD1-derived perception extension. HD2 has now shown that affect/emotion/mood/appraisal is another repeated interface-rich/mechanism-thin neighboring structure spanning HF4/HF5/HF14/HF20 and multiple downstream Human processes. Cross-cultural, developmental, lesion, interoceptive, mood-learning, spontaneous-expression and social-emotion falsification satisfied the explicit `NextFoundationAdmissionCondition` without contradicting any established HF claim.

The resulting canonical extension is [`../research/foundations/HF21-AFFECT-EMOTION-MOOD-APPRAISAL.md`](../research/foundations/HF21-AFFECT-EMOTION-MOOD-APPRAISAL.md), with evidence bridge [`../research/foundations/HF21-SOURCES.md`](../research/foundations/HF21-SOURCES.md) and current foundation continuation [`../research/foundations/HF21-CONTINUATION.md`](../research/foundations/HF21-CONTINUATION.md). HF21 is the thin reusable surface; [`../research/deep-foundations/HD2-AFFECT-EMOTION-MOOD-APPRAISAL.md`](../research/deep-foundations/HD2-AFFECT-EMOTION-MOOD-APPRAISAL.md) and [`../research/deep-foundations/HD2-SOURCES.md`](../research/deep-foundations/HD2-SOURCES.md) own the full model comparison, primary evidence and falsifier matrix. **HF22 is UNKNOWN / not admitted.**

The separate second-generation **Human Deep Foundations** mode remains the mechanism-depth pressure layer. [`../research/deep-foundations/HD2-CONTINUATION.md`](../research/deep-foundations/HD2-CONTINUATION.md) admits **HD3 — Social Cognition, Other-Mind Modeling, Attachment, Care and Persistent Relations** as the next non-foundation route. `HD3 != HF22`.
