...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is perception; HF21 is affective world coupling; HF22 is persistent participant-specific relationship state; HF23 is the HD5-derived generative-symbolic-system extension. HD9 has now completed the organismic-systems/health/disease deep route after HD8, reconstructing multi-scale organismic state, disease/illness/pathology distinctions, biomarker/diagnosis/risk boundaries, immune–metabolic–endocrine–vascular/cardiorenal coupling, microbiome-host ecology, reserve/recovery, chronic remodeling and multimorbidity trajectories.

HD9 strengthens the biological-implementation grammar without turning Human into an organ inventory. Its durable distinctions include `OrganBoundary != CausalBoundary`, `Health != NoDiagnosis`, `Disease != Symptom != Sign != Biomarker != Diagnosis`, `ReferenceRange != OptimalRange != IndividualBaseline`, `Biomarker != Mechanism`, `Inflammation != OneScalar`, `ImmuneState != IndependentOfMetabolism`, `HormoneLevel != EndocrineFunction`, `Microbiome != OneOrgan`, `ChronicDisease != AcuteDiseaseForLonger` and `TreatmentResponse != MechanismProof`.

HD9 is a no-promotion result. Health is a multidimensional projection/evaluation, disease/pathophysiology is a cross-system trajectory domain, body systems are projection families, and multisystem integration is a relation/process rather than one Human subsystem. [`../research/foundations/HF23-CONTINUATION.md`](../research/foundations/HF23-CONTINUATION.md) therefore remains the current foundation continuation; **HF24 remains UNKNOWN / not admitted**, and HF0–HF23 were not reopened. [`../research/deep-foundations/HD9-ORGANISMIC-SYSTEMS-HEALTH-DISEASE-PATHOPHYSIOLOGY.md`](../research/deep-foundations/HD9-ORGANISMIC-SYSTEMS-HEALTH-DISEASE-PATHOPHYSIOLOGY.md) and [`../research/deep-foundations/HD9-SOURCES.md`](../research/deep-foundations/HD9-SOURCES.md) own the mechanism/evidence reconstruction.

The separate second-generation **Human Deep Foundations** mode continues through [`../research/deep-foundations/HD9-CONTINUATION.md`](../research/deep-foundations/HD9-CONTINUATION.md). A fresh global residual scan selects **HD10 — Narrative, Imagination, Fiction, Event Models and Possible-World Construction** as the next non-foundation route. `HD10 != HF24`; collective identity/intergroup dynamics, psychopathology, sleep/dreaming, built environment/ecology and creativity/play/aesthetics remain later residual candidates.
