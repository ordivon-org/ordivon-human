...
HF0–HF18 remain the frozen first-cycle library; HF19 is the production/economic-organization extension; HF20 is perception; HF21 is affective world coupling; HF22 is persistent participant-specific relationship state; HF23 is the HD5-derived generative-symbolic-system extension. HD5 pressure-tested language/symbolic structure across infant acquisition, homesign and emerging sign languages, signed/spoken modalities, aphasia, cross-language cognition, semantics/pragmatics, comparative composition, writing/literacy and LLM/multimodal grounding.

HD5 produced a positive neighboring-foundation result after HD4's no-promotion round. The missing object is not `Language` narrowly and not generic `Meaning`; it is a persistent socially stabilized **Generative Symbolic System** that supplies reusable sign/form types, learned form↔content mappings, combinatorial/construction resources, semantic/reference resources, pragmatic/use conventions and productivity across many use events. HF8 can represent generic vehicle/content/referent/truth, HF12 can represent one communication/reference/repair event, HF13 can stabilize conventions, and HD4 can explain transmission/change, but none owns this persistent symbolic-system object without hidden expansion.

The resulting canonical extension is [`../research/foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md`](../research/foundations/HF23-SYMBOLIC-SYSTEMS-LANGUAGE-MEANING.md), with evidence bridge [`../research/foundations/HF23-SOURCES.md`](../research/foundations/HF23-SOURCES.md) and current foundation continuation [`../research/foundations/HF23-CONTINUATION.md`](../research/foundations/HF23-CONTINUATION.md). HF23 is the thin reusable surface; [`../research/deep-foundations/HD5-LANGUAGE-SYMBOL-REFERENCE-MEANING-GENERATIVE-SYSTEMS.md`](../research/deep-foundations/HD5-LANGUAGE-SYMBOL-REFERENCE-MEANING-GENERATIVE-SYSTEMS.md) and [`../research/deep-foundations/HD5-SOURCES.md`](../research/deep-foundations/HD5-SOURCES.md) own the full theory/evidence/falsifier reconstruction. **HF24 is UNKNOWN / not admitted**, and HF0–HF22 were not reopened.

The separate second-generation **Human Deep Foundations** mode remains the mechanism-depth pressure layer. [`../research/deep-foundations/HD5-CONTINUATION.md`](../research/deep-foundations/HD5-CONTINUATION.md) provisionally localizes **HD6 — Narrative, Imagination, Fiction, Event Models and Possible-World Construction** as the next non-foundation route, subject to a lightweight residual check before execution. `HD6 != HF24`.
